...
>
  ...
  <hr class="flex-grow border-t border-gray-300"/>
        ...
        <div
  className={`bg-primary w-full overflow-y-auto md:overflow-y-scroll md:w-6/12  px-2 2xl:py-10 py-3 text-white rounded-lg transition-transform duration-500 ease-in-out 
